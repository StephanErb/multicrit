...
/** @file mcstl_omp_loop.h
 *  @brief Parallelization of embarrassingly parallel execution by means of an OpenMP for loop. */

#ifndef _MCSTL_OMP_LOOP_H
#define _MCSTL_OMP_LOOP_H 1
...
{	
	...
	thread_index_t num_threads = (SETTINGS::num_threads < (end - begin)) ? SETTINGS::num_threads : static_cast<thread_index_t>((end - begin));
