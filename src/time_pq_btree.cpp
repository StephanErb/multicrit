...
int main(int argc, char ** args) {
	...
	if (k != 0) {
		...
		timeBulkInsertion(100, ratio, skew, iterations *     1000, p, heatmap);
		timeBulkInsertion(316, ratio, skew, iterations *     1000, p, heatmap);
		timeBulkInsertion(1000, ratio, skew, iterations *    1000, p, heatmap);
		timeBulkInsertion(3162, ratio, skew, iterations *    1000, p, heatmap);
		timeBulkInsertion(10000, ratio, skew, iterations *    100, p, heatmap);
		timeBulkInsertion(31622, ratio, skew, iterations *    100, p, heatmap);
		timeBulkInsertion(100000, ratio, skew, iterations *    10, p, heatmap);
		timeBulkInsertion(316227, ratio, skew, iterations *    10, p, heatmap);
		timeBulkInsertion(1000000, ratio, skew, iterations *    5, p, heatmap);
		timeBulkInsertion(3162277, ratio, skew, iterations *    5, p, heatmap);
		timeBulkInsertion(10000000, ratio, skew, iterations *   5, p, heatmap);
	}
	return 0;
} 
