...
int main(int argc, char ** args) {
	...
	if (k != 0) {
		...
		timeBulkInsertion(316, ratio, skew, iterations *     3000, p);
		timeBulkInsertion(1000, ratio, skew, iterations *    3000, p);
		timeBulkInsertion(3162, ratio, skew, iterations *    3000, p);
		timeBulkInsertion(10000, ratio, skew, iterations *    300, p);
		timeBulkInsertion(31622, ratio, skew, iterations *    300, p);
		timeBulkInsertion(100000, ratio, skew, iterations *    30, p);
		timeBulkInsertion(316227, ratio, skew, iterations *    30, p);
		timeBulkInsertion(1000000, ratio, skew, iterations *   10, p);
		timeBulkInsertion(3162277, ratio, skew, iterations *   10, p);
