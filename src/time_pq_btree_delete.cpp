...
int main(int argc, char ** args) {
	...
	timeBulkDeletion(100, ratio, skew, iterations *     1000, p, insert_and_delete_separated, insert_and_delete_combined);
	timeBulkDeletion(316, ratio, skew, iterations *     1000, p, insert_and_delete_separated, insert_and_delete_combined);
	timeBulkDeletion(1000, ratio, skew, iterations *    1000, p, insert_and_delete_separated, insert_and_delete_combined);
	timeBulkDeletion(3162, ratio, skew, iterations *    1000, p, insert_and_delete_separated, insert_and_delete_combined);
	timeBulkDeletion(10000, ratio, skew, iterations *    100, p, insert_and_delete_separated, insert_and_delete_combined);
	timeBulkDeletion(31622, ratio, skew, iterations *    100, p, insert_and_delete_separated, insert_and_delete_combined);
	timeBulkDeletion(100000, ratio, skew, iterations *    10, p, insert_and_delete_separated, insert_and_delete_combined);
	timeBulkDeletion(316227, ratio, skew, iterations *    10, p, insert_and_delete_separated, insert_and_delete_combined);
	timeBulkDeletion(1000000, ratio, skew, iterations *    5, p, insert_and_delete_separated, insert_and_delete_combined);
	timeBulkDeletion(3162277, ratio, skew, iterations *    5, p, insert_and_delete_separated, insert_and_delete_combined);
	timeBulkDeletion(10000000, ratio, skew, iterations *   5, p, insert_and_delete_separated, insert_and_delete_combined);
	return 0;
} 
