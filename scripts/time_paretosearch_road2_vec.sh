...
do
	...
	taskset -c 0-$((p-1)) ./bin/time_road_instances2_paretosearch_ls_vec.par -d ../instances/ -g NY -c $iter_count -p $p > $out_file
done

out_file="../timings/road2_paretosearch_sequ_vec"
echo "Writing to sequential computation to $out_file"
taskset -c 0 ./bin/time_road_instances2_paretosearch_ls_vec -d ../instances/ -g NY -c $iter_count > $out_file
